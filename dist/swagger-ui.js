...
(function() {
  var template = Handlebars.template, templates = Handlebars.templates = Handlebars.templates || {};
templates['param_list_multiple'] = template(function (Handlebars,depth0,helpers,partials,data) {
  this.compilerInfo = [4,'>= 1.0.0'];
helpers = this.merge(helpers, Handlebars.helpers); data = data || {};
  var buffer = "", stack1, stack2, self=this, functionType="function", escapeExpression=this.escapeExpression;
...
function program11(depth0,data) {
  ...
  buffer += escapeExpression(stack1)
    + "</td>\n<td>\n    <select class='parameter' multiple=\"multiple\" name='";
  if (stack1 = helpers.name) { stack1 = stack1.call(depth0, {hash:{},data:data}); }
  else { stack1 = depth0.name; stack1 = typeof stack1 === functionType ? stack1.apply(depth0) : stack1; }
  buffer += escapeExpression(stack1)
    + "'>\n		";
  ...
  ParameterView = (function(_super) {
    ...
    ParameterView.prototype.render = function() {
      ...
      if (this.model.allowMultiple) {
        $('<span class="allow-multiple">(Multiple, comma separated)</span>').appendTo($('.model-signature', $(this.el)));
      }
      contentTypeModel = {
        isParam: false
      };
    ...
    ParameterView.prototype.template = function() {
      if (this.model.isList) {
        if (this.model.allowMultiple) {
          return Handlebars.templates.param_list_multiple;
        } else {
